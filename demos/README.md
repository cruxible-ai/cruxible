...
Demos are exploratory examples and future kit candidates. They may be useful for
experimentation, but they are not maintained as first-class 0.2 kits.

## Exploratory Examples

| Demo | Domain | Purpose |
|---|---|---|
| [drug-interactions](drug-interactions/) | Healthcare | Multi-drug interaction checks with CYP450 enzyme data. |
