...
from cruxible_core.providers.provider_local_runtime import _open_secret_channel, _run_child
...
from cruxible_core.providers.provider_runtime_contract import ProviderRuntimeBudgetsV1
...
def test_c3_effect_class_is_governed_and_unchanged_in_this_range() -> None:
    execution = (SOURCE_ROOT / "procedures" / "execution.py").read_text("utf-8")
...
def test_l6_exactly_one_owner_closes_the_secret_read_descriptor() -> None:
    source = (SOURCE_ROOT / "providers" / "provider_local_runtime.py").read_text("utf-8")
...
def test_c10_caps_carry_no_numeric_literal() -> None:
    source = SOURCE_ROOT / "providers" / "provider_local_runtime.py"
...
def test_l12_every_fence_timeout_is_config_carried() -> None:
    ...
    text = (SOURCE_ROOT / "providers" / "provider_process_leases.py").read_text("utf-8")
