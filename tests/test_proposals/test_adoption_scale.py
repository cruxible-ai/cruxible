...
from cruxible_core.service.proposals.proposal_receive import ProposalReceiveOperationalConfigV1
from tests.core_support._adoption_fixture import MINIATURE, TIER_1, build_fixture
