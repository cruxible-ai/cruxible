...
from cruxible_core.playbill import citation_index as index_module
from cruxible_core.playbill import citation_relations as relations
...
def test_cache_coordinates_eviction_clear_and_lossy_parent_fallback(tmp_path):
    ...
    from cruxible_core.playbill.derived_state import DerivedState
    from cruxible_core.playbill.projection import AssemblerRequest
