...
from cruxible_core.playbill.authoring.lowering import _same_predicate_claims
...
from tests.test_playbill.test_authoring_change_set_intents import _accept, _coordinator
...
from tests.test_playbill.test_evaluation_state_cache import _tree
...
def test_history_does_not_disable_semantic_evaluation_retention(monkeypatch):
    from cruxible_core.playbill import evaluation_state_cache as module
...
def test_fast_path_collision_retains_cold_refusal_bytes():
    from cruxible_core.playbill.proposals import advance_tree_members
...
def test_external_nfc_input_keeps_cold_normalization_boundary():
    from cruxible_core.playbill.derived_state import snapshot_against
    from cruxible_core.playbill.proposals import advance_tree_members
