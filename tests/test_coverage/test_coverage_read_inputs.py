...
def test_frozen_coverage_claim_model_retains_historical_codec_and_path_refusal() -> None:
    ...
    from cruxible_core.indexes.claims.projection_claims import claim_projection_view
    from cruxible_core.indexes.projection import AcceptedProjectionCoordinate
    from cruxible_core.service.claims.claims import _public_claim
    from tests.test_claims.test_claim_citations import _v2_claim
