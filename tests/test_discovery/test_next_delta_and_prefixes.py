...
from cruxible_core.authoring.id_prefixes import (
    MINIMUM_PREFIX_HEX,
    AmbiguousIdPrefix,
    resolve_id_prefix,
)
...
def test_a_delta_against_an_unknown_digest_returns_the_whole_queue() -> None:
    ...
    from cruxible_core.service.discovery.next import _delta_of
...
def test_v2_delta_reports_every_removal_in_ascii_order() -> None:
    from cruxible_core.service.discovery.next import _delta_of, _remember_queue
