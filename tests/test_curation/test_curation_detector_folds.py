...
from cruxible_core.curation.curation_detectors import (
...
from cruxible_core.exhaust.consumption import ConsumptionAggregateV1
...
def test_recurring_conflict_fold_uses_the_published_slot_threshold(
    ...
    monkeypatch.setattr(
        "cruxible_core.curation.curation_detectors.RECURRING_CONFLICT_MINIMUM_UNRESOLVED_SLOTS",
        2,
    )
...
def test_literal_subject_reference_calibration_knob_disables_the_fold(
    ...
    monkeypatch.setattr(
        "cruxible_core.curation.curation_detectors.LITERAL_SUBJECT_REFERENCE_DETECTOR_ENABLED",
        False,
    )
...
def test_run_curation_detectors_builds_shared_history_once_for_all_history_consumers(
    ...
    import cruxible_core.curation.curation_detectors as detector_module
