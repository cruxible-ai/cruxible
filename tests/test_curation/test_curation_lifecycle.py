...
from cruxible_core.curation.curation_detectors import CurationDetectorResult
...
def _serve_detection(
    ...
    *,
    ...
    monkeypatch.setattr(
        "cruxible_core.service.discovery.curation._generation",
...
def test_every_accepted_public_curation_action_preserves_replay(
    ...
    try:
        if action == "overrule":
            ...
            monkeypatch.setattr(
                "cruxible_core.service.discovery.curation._accepted_change",
                lambda *args, **kwargs: (
            ...
            monkeypatch.setattr(
                "cruxible_core.service.discovery.curation._affected_members",
                lambda *args, **kwargs: affected,
            )
            monkeypatch.setattr(
                "cruxible_core.service.discovery.curation._related_paths",
