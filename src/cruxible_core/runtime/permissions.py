...
TOOL_PERMISSIONS: dict[str, PermissionMode] = {
    ...
    "cruxible_playbill_procedure_readings": PermissionMode.READ_ONLY,
    "cruxible_playbill_line_check": PermissionMode.READ_ONLY,
    "cruxible_playbill_line_listen": PermissionMode.GOVERNED_WRITE,
    ...
    "cruxible_playbill_curation_accept_fixed": PermissionMode.GOVERNED_WRITE,
    "cruxible_playbill_curation_suppress": PermissionMode.GOVERNED_WRITE,
    "cruxible_playbill_expand": PermissionMode.READ_ONLY,
    "cruxible_playbill_export_floor": PermissionMode.READ_ONLY,
    "cruxible_playbill_workspace_floor_export": PermissionMode.READ_ONLY,
    "cruxible_playbill_workspace_floor_status": PermissionMode.READ_ONLY,
    ...
    "cruxible_playbill_workspace_source_check": PermissionMode.READ_ONLY,
    "cruxible_playbill_workspace_coverage_resolve": PermissionMode.READ_ONLY,
    "cruxible_playbill_workspace_coverage_status": PermissionMode.READ_ONLY,
    ...
    "cruxible_playbill_authoring_example": PermissionMode.READ_ONLY,
    ...
    "cruxible_playbill_procedure_bind": PermissionMode.GOVERNED_WRITE,
    ...
    "cruxible_playbill_claim_attest_new_capture": PermissionMode.GOVERNED_WRITE,
