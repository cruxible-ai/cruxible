...
RUNTIME_OPERATION_PERMISSIONS: dict[str, PermissionMode] = {
    ...
    # Asymmetric config-refresh gate: recomposing from the source pointer is
    # GRAPH_WRITE for tightening/neutral governance diffs; a WEAKENING diff
    # escalates to the companion ADMIN requirement below (checked by the
