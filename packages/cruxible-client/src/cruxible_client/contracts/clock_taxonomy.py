...
CLOCK_FIELD_DECLARATIONS: Mapping[tuple[str, str], ClockDomainV1] = {
    ...
    ("PlaybillLedgerMirrorV1", "requested_sequence"): "SETTLEMENT ORDER",
    ("PlaybillLedgerMirrorV1", "attempted_sequence"): "SETTLEMENT ORDER",
    ...
    ("PlaybillProposalWithdrawResult", "withdrawn_at"): "ASSERTION TIME",
    ...
    ("PlaybillProcedureReadingsResultV1", "observation_time"): "EVALUATION INSTANT",
    ("ProcedureMeasurementEligibilityV1", "activated_at"): "ASSERTION TIME",
    ("ProcedureMeasurementEligibilityV1", "check_at"): "EVALUATION INSTANT",
    ("ProcedureMeasurementEligibilityV1", "expires_at"): "VALIDITY WINDOW",
    ("ProcedureMeasurementEligibilityV1", "observation_time"): "EVALUATION INSTANT",
    ("ProcedureMeasurementResolutionSummaryV1", "observed_at"): "ASSERTION TIME",
    ("ProcedureMeasurementResolutionSummaryV1", "recorded_at"): "ASSERTION TIME",
    ("ProcedureMeasurementResolutionSummaryV1", "sequence"): "SETTLEMENT ORDER",
    ("ProcedureReadingSummaryV1", "observed_at"): "ASSERTION TIME",
    ("ProcedureReadingSummaryV1", "recorded_at"): "ASSERTION TIME",
